...
public class CreaActivity extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        return true; //hmm nose si ha d'anar aqui
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ImageView imageView = (ImageView)findViewById(R.id.c_edit_image);
        ...
        //intent de camerà que assigna la imatge feta a la camara o de la galaria al imageView
        //mètode per càrregar la imatge de l'imageview al Google Cloud Storage
    }
